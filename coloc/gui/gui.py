...
class MyTableWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.thresholdDropdown.setToolTip("Threshold refers to the degree of pixel noise filtering. Higher thresholds result in more filtering")
        ...
        self.channelsDropdown.setToolTip("Channels indicates how many colour spaces from the RGB spectrum are available. For example, cells stained with GFP and Texas Red would require 2 channels.")
        ...
        self.clusterNoLabel.setToolTip("Clusters determines the number of colocalisations detected.")
        self.intensitycorrCheckbox = QCheckBox()
        self.intensitycorrCheckbox.setToolTip("Based on fluorescence correlation")
